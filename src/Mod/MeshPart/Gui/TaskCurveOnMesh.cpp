...
void CurveOnMeshWidget::setup()
{
    ...
    ui->continuity->addItem(QString("C0"), static_cast<int>(GeomAbs_C0));
    ui->continuity->addItem(QString("C1"), static_cast<int>(GeomAbs_C1));
    ui->continuity->addItem(QString("C2"), static_cast<int>(GeomAbs_C2));
    ui->continuity->addItem(QString("C3"), static_cast<int>(GeomAbs_C3));
