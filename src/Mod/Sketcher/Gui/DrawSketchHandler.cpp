...
void DrawSketchHandler::renderSuggestConstraintsCursor(std::vector<AutoConstraint> &suggestedConstraints)
{
    ...
    for (; it != suggestedConstraints.end(); ++it, i++) {
        ...
        {
        case Horizontal:
            iconType = QString("Constraint_Horizontal");
            break;
        case Vertical:
            iconType = QString("Constraint_Vertical");
            break;
        case Coincident:
            iconType = QString("Constraint_PointOnPoint");
            break;
        case PointOnObject:
            iconType = QString("Constraint_PointOnObject");
            break;
        case Tangent:
            iconType = QString("Constraint_Tangent");
            break;
        default:
            break;
        }
