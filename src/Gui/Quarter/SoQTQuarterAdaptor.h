...
public:
    explicit SoQTQuarterAdaptor(QWidget* parent = 0, const QOpenGLWidget* sharewidget = 0, Qt::WindowFlags f = 0);
    explicit SoQTQuarterAdaptor(const QSurfaceFormat& format, QWidget* parent = 0, const QOpenGLWidget* shareWidget = 0, Qt::WindowFlags f = 0);
    explicit SoQTQuarterAdaptor(QOpenGLContext* context, QWidget* parent = 0, const QOpenGLWidget* sharewidget = 0, Qt::WindowFlags f = 0);
