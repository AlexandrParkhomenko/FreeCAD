...
void TextEdit::complete()
{
    ...
    QStringList list = toPlainText().split(QRegExp( QString("\\W+")));
...
struct TextEditorP
{
    ...
    TextEditorP()
    {
        ...
        colormap[ QString("Current line highlight")] = QColor(224,224,224);
    }
};
} // namespace Gui
...
{
    return fontMetrics().horizontalAdvance(QString("0000"))+10;
}
...
void TextEditor::highlightCurrentLine()
{
    ...
    if (!isReadOnly()) {
        ...
        QColor lineColor = d->colormap[ QString("Current line highlight")];
...
void TextEditor::OnChange(Base::Subject<const char*> &rCaller,const char* sReason)
{
    ...
    if (strcmp(sReason, "FontSize") == 0 || strcmp(sReason, "Font") == 0) {
        ...
        if (it != d->colormap.end()) {
            ...
            if (this->highlighter)
                this->highlighter->setColor( QString(sReason), color);
        }
    }
...
//#        int fontSize = metric.horizontalAdvance( QString("0"));
